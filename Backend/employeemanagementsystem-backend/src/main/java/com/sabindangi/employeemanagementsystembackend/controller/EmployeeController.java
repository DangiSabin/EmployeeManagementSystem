package com.sabindangi.employeemanagementsystembackend.controller;
...
import com.sabindangi.employeemanagementsystembackend.exception.ResourceNotFoundException;
import com.sabindangi.employeemanagementsystembackend.model.Employee;
import com.sabindangi.employeemanagementsystembackend.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> getEmployeeById(@PathVariable Long id){
		Employee e=employeeRepository.findById(id)
				.orElseThrow(()->new ResourceNotFoundException("Employee do not exist for id:"+id));
